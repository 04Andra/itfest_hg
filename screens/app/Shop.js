        ...
        <View style={{flex: 1}}>
            ...
            <View style={{alignItems: 'flex-end', padding: 18, height: "15%"}}>
                <Image
                    ...
                    style={{width: "15%", height: "90%", borderRadius: 80, shadowRadius: 0.2}}/>
            </View>
                        ...
                        <View style={{flexDirection: 'row', gap: 10}}>
                            {
                                cards.map(card =>
                                    <>
                                        <KProduct img={card.img} produced={card.produced} farmer={card.farmer}
                                                  prodName={card.prodName} price={card.price}/>
                                    </>
                                )
                            }
                        </View>
